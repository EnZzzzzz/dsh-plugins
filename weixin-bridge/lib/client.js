			...
			return /* @__PURE__ */ (0, react_jsx_runtime.jsxs)("div", {
				...
				children: [
					...
					/* @__PURE__ */ (0, react_jsx_runtime.jsx)("p", {
						...
						children: "连接微信，让 Harness 的 agent 通过微信收发消息。扫码即可连接，无需终端。"
					}),
					callError !== void 0 && /* @__PURE__ */ (0, react_jsx_runtime.jsxs)("p", {
						style: {
							margin: "0 0 12px",
							color: "#c0392b"
						},
						children: ["与主进程通信失败：", callError]
					}),
					/* @__PURE__ */ (0, react_jsx_runtime.jsxs)("div", {
						...
						children: [/* @__PURE__ */ (0, react_jsx_runtime.jsx)("div", {
							style: { flexShrink: 0 },
							children: phase === "waiting" && status?.qrUrl !== void 0 ? /* @__PURE__ */ (0, react_jsx_runtime.jsx)(QrCode, {
								url: status.qrUrl,
								size: 200
								...
								children: phase === "connected" ? "已连接 ✓" : phase === "error" ? "连接失败" : "尚未开始登录"
							})
						}), /* @__PURE__ */ (0, react_jsx_runtime.jsxs)("div", {
							style: {
								flex: 1,
							...
							children: [
								/* @__PURE__ */ (0, react_jsx_runtime.jsx)(Row, {
									label: "状态",
									children: phase === "waiting" ? status?.scanned === true ? "已扫码，请在手机上确认登录" : "等待扫码…" : phase === "connected" ? "已连接" : phase === "error" ? "失败" : "未连接"
								}),
								/* @__PURE__ */ (0, react_jsx_runtime.jsx)(Row, {
									label: "说明",
									children: message ?? "打开设置页后点击「开始连接」生成二维码。"
								}),
								status?.accountId !== void 0 && /* @__PURE__ */ (0, react_jsx_runtime.jsx)(Row, {
									label: "账号",
									children: status.accountId
								}),
								/* @__PURE__ */ (0, react_jsx_runtime.jsx)(Row, {
									label: "插件",
									children: "dsh-weixin-bridge（host 桥接 + 浏览器页面）"
								}),
								/* @__PURE__ */ (0, react_jsx_runtime.jsx)(Row, {
									label: "消息类型",
									children: "文本（图片/语音/视频/文件暂不转发内容，仅附说明）"
								}),
								/* @__PURE__ */ (0, react_jsx_runtime.jsx)(Row, {
									label: "会话模型",
									children: "一个微信会话对应一个 Harness session，多轮对话保留历史"
								}),
								/* @__PURE__ */ (0, react_jsx_runtime.jsxs)("div", {
									style: {
										display: "flex",
									...
									children: [
										phase === "idle" && /* @__PURE__ */ (0, react_jsx_runtime.jsx)(ActionButton, {
											onClick: () => {
												startLogin();
											},
											disabled: busy,
										...
										phase === "waiting" && /* @__PURE__ */ (0, react_jsx_runtime.jsx)(ActionButton, {
											onClick: () => {
												startLogin();
											},
											disabled: busy,
										...
										phase === "error" && /* @__PURE__ */ (0, react_jsx_runtime.jsx)(ActionButton, {
											onClick: () => {
												startLogin();
											},
											disabled: busy,
								...
								/* @__PURE__ */ (0, react_jsx_runtime.jsx)("p", {
									...
									children: "提示：扫码连接使用个人微信号，存在账号风险，请自行评估。重启后会话映射会重建；主动发消息暂未实现。"
								})
							]
						})]
					})
