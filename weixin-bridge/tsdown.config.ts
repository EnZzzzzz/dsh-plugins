/**
 * Build the browser client bundle for dsh-weixin-bridge. Emits the closure
...
const config: UserConfig = {
  ...
  outputOptions: {
    ...
    banner: 'window.__ModuleLoader__.load({ id: "dsh-weixin-bridge", factory: (require) => {',
